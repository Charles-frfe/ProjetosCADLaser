...
namespace ProjetosCADLaser.Services
{
    public sealed class ConfiguracaoLocalService
    {
        ...
        public ConfiguracaoLocal Carregar() { return File.Exists(CaminhoPadrao) ? _json.Read<ConfiguracaoLocal>(CaminhoPadrao) : new ConfiguracaoLocal(); }
        ...
        public void Salvar(ConfiguracaoLocal configuracao) { JsonContratosV1.ValidarPodeEditar(configuracao); _json.WriteAtomic(CaminhoPadrao, configuracao); }
    }
