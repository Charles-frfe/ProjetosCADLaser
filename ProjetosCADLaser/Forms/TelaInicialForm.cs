    ...
    public sealed partial class TelaInicialForm : Form
    {
        ...
        private void CriarAreaCentral()
        {
            ...
            _cardAcoes = new Panel
            {
                ...
                Size = new Size(540, _local.Perfil == PerfilUsuario.Operacional ? 330 : 250),
            ...
            _gradeAcoes = new TableLayoutPanel
            {
                ...
                Anchor = AnchorStyles.None,
                ColumnCount = 2,
                RowCount = _local.Perfil == PerfilUsuario.Operacional ? 2 : 1,
                Margin = new Padding(0)
            };
            ...
            else
            {
                ...
                _gradeAcoes.SetColumnSpan(_pesquisar, 2);
